...
type Flat = {
  ...
  area: string;
  img: string;
  projectId: string; // link flat to project
};
          ...
          <article key={flat.id} className="overflow-hidden rounded-lg border">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button
                  onClick={() => openProject(flat.projectId)}
...
// Reuse the same ProjectModal component from your ProjectsPage here
// Copy your ProjectModal, EMICalculator, QuickInquiry, ShareButtons components as is
