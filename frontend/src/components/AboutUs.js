            ...
            <div className="about-us-content">
                ...
                */}
                <div className="about-us-mission">
                    ...
                    "At Six Square Builders, we strive to execute each project to the highest standards, ensuring on-time delivery and 
                    exceptional service for our customers. Our commitment to quality and precision drives every aspect of our work. We believe 
                    in fostering an amicable work environment for our team, empowering them to perform at their best. In addition, we strictly 
                    adhere to effective AEC (Architecture, Engineering, and Construction) practices, ensuring that each project is executed 
                    efficiently and sustainably. Our dedication to excellence reflects our passion for shaping the future of real estate."
                    </p>
                </div>
                ...
                <div className="about-us-vision">
                    ...
                    "Six Square Builders' vision is to emerge as a premier architectural, engineering, and construction company in Chennai, 
                    offering high-quality homes at affordable prices. We strive to be the preferred choice for our clients' housing needs, 
                    delivering exceptional value and excellence in every project. With a commitment to innovation, sustainability, and customer 
                    satisfaction, we aim to build lasting relationships and contribute to the development of vibrant communities."
                    </p>
                </div>
            </div>
        </div>
