          ...
          >
            ...
            >
              <div className="card__image-container">
                ...
                />
                <div
                  className={`card__image-reveal ${visibleProjects.includes(index) ? "visible" : ""}`}
                />
              </div>
              <div className={`card__content ${showContent.includes(index) ? "visible" : ""}`}>
                <div
                  className="card__title"
                  style={{ pointerEvents: "none", color: "#000000ff", cursor: "pointer" }}
                >
                  {project.title}
                </div>
      ...
      {openIndex !== null && (
        <div className="luxury-modal-overlay" onClick={() => setOpenIndex(null)}>
          <div className="luxury-modal" onClick={(e) => e.stopPropagation()}>
            <button className="luxury-modal-close" onClick={() => setOpenIndex(null)} aria-label="Close">
              &times;
            </button>
            ...
            <div className="luxury-modal-info">
              ...
              <div className="luxury-modal-extra">
                <ul>
                  {projects[openIndex].more?.map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
              </div>
